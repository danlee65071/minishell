...
Для диагностики ошибок всех системных вызовов преду- смотрена внешняя переменная errno, если какой-нибудь системный вызов завершился с ошибкой, то код ошибки заносится в errno.
